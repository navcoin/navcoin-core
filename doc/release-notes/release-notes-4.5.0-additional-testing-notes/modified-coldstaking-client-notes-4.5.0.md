...
#### Aim & wallet setup: 
To test whether a modified wallet with a spending key can stake cold-staking inputs
...
#### Aim & wallet setup: 
To test whether a modified wallet with a staking key can send staking outputs to another address
