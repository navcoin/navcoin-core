...
Then, to tunnel a SSL connection on 25555 to a RPC server bound on localhost on port 18332 do:

    stunnel -d 25555 -r 127.0.0.1:18332 -p stunnel.pem -P ''
...
- #6504 `b6fee6b` Rationalize currency unit to "NAV" (Ross Nicoll)
