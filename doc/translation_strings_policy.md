...
This document provides guidelines for internationalization of the DeVault Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `devault_en.ts` remains unchanged.
