...
$(package)_config_opts_darwin=RANLIB="$(host_prefix)/native/bin/x86_64-apple-darwin18-ranlib" AR="$(host_prefix)/native/bin/x86_64-apple-darwin18-ar" CC="$(host_prefix)/native/bin/$($(package)_cc)"
endef
