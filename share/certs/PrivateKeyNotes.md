...
unlocked to sign the DeVault-Qt.app bundle.
...
allowing somebody to distribute a DeVault-Qt.app or devault-qt-setup.exe with a valid
...
that the devault-qt.exe file inside the installer had not been tampered with.
