...
unlocked to sign the NavCoin-Qt.app bundle.
...
allowing somebody to distribute a NavCoin-Qt.app or navcoin-qt-setup.exe with a valid
...
that the navcoin-qt.exe file inside the installer had not been tampered with.
