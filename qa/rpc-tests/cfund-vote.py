...
class CommunityFundVotes(NavCoinTestFramework):
    ...
    def run_test(self):
        ...
        blockhash_yes = self.nodes[0].generate(1)[0]
        ...
        blockhash_no = self.nodes[0].generate(1)[0]
        ...
        self.nodes[0].generate(self.nodes[0].cfundstats()["consensus"]["blocksPerVotingCycle"] - 10)
        self.nodes[0].proposalvote(proposalid0, "yes")
        ...
        firstblockofcycle = self.nodes[0].generate(1)[0]
