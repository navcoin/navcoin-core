/* src/config/navcoin-config.h.  Generated from navcoin-config.h.in by configure.  */
/* src/config/navcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NAVCOIN_CONFIG_H

#define NAVCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The NavCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "NavCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/navcoin/navcoin-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NavCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NavCoin Core 4.1.0"
