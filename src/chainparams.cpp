...
public:
    CMainParams() {
        ...
        // Deployment of SegWit (BIP141 and BIP143)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT_DUMMY].bit = 5;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT_DUMMY].nStartTime = 1493424000; // May 1st, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT_DUMMY].nTimeout = 1525132800; // May 1st, 2018
