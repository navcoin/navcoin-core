...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 32;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1492875152; //1493596800; // May 1st, 2017
