...
#ifndef DEVAULT_WALLET_DVTTECH_H
#define DEVAULT_WALLET_DVTTECH_H
...
#define DVTTECH_DEFAULT_INPUT_DELAY 1
#define DVTTECH_DEFAULT_OUT_DELAY 10
#define DVTTECH_DEFAULT_ENTROPY 4
...
#endif //DEVAULT_WALLET_DVTTECH_H
