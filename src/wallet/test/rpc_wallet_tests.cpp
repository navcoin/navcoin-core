...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CDeVaultAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CDeVaultAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CDeVaultAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CDeVaultAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CDeVaultAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDeVaultAddress(arr[0].get_str()).Get() == demoAddress.Get());
