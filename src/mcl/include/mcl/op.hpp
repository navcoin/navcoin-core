...
struct Op {
	...
	*/
	...
	void4u mcl_fp_mul;
	void3u mcl_fp_sqr;
	void2uOp mcl_fp_invOp;
	void2uIu mcl_fp_mulUnit; // fpN1_mod + mcl_fp_mulUnitPre

	void3u fpDbl_mulPre;
	void2u fpDbl_sqrPre;
	int2u mcl_fp_preInv;
	void2uI mcl_fp_mulUnitPre; // z[N + 1] = x[N] * y
	...
	u3u mcl_fp_addPre; // without modulo p
	u3u mcl_fp_subPre; // without modulo p
	u3u fpDbl_addPre;
	u3u fpDbl_subPre;
	/*
		for Fp2 = F[u] / (u^2 + 1)
