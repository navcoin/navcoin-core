...
void SyncWithWallets(const CTransaction &tx, const CBlockIndex *pindex, const CBlock *pblock, const bool fConnect) {
    g_signals.SyncTransaction(tx, pindex, pblock, fConnect);
}
