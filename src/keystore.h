...
#ifndef DEVAULT_KEYSTORE_H
#define DEVAULT_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/devault/bips/blob/master/bip-0013.mediawiki
