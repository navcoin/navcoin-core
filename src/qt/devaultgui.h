...
#ifndef DEVAULT_QT_DEVAULTGUI_H
#define DEVAULT_QT_DEVAULTGUI_H
...
/**
  DeVault GUI main class. This class represents the main window of the DeVault UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DeVaultGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DeVaultGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DeVaultGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a devault wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
