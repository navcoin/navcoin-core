...
#ifndef DEVAULT_QT_DEVAULTUNITS_H
#define DEVAULT_QT_DEVAULTUNITS_H
...
/** DeVault unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DeVaultUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DeVaultUnits(QObject *parent);

    /** DeVault units.
      @note Source: https://en.devault.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DVT,
...
typedef DeVaultUnits::Unit DeVaultUnit;

#endif // DEVAULT_QT_DEVAULTUNITS_H
