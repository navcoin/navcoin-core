    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return NavCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, NavCoinUnits::separatorNever);
            else
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+NavCoinUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
