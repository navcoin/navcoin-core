...
void NavcoinGUI::updatePrice()
{
    ...
    std::thread pThread{[this]{
        ...
        try {
            ...
            QSettings settings;
            // Save the values
            settings.setValue("btcFactor", (1.0 / json.get<double>("btc")) * 100000000);
            settings.setValue("eurFactor", (1.0 / json.get<double>("eur")) * 100000000);
            settings.setValue("usdFactor", (1.0 / json.get<double>("usd")) * 100000000);
            settings.setValue("arsFactor", (1.0 / json.get<double>("ars")) * 100000000);
            settings.setValue("audFactor", (1.0 / json.get<double>("aud")) * 100000000);
            settings.setValue("brlFactor", (1.0 / json.get<double>("brl")) * 100000000);
            settings.setValue("cadFactor", (1.0 / json.get<double>("cad")) * 100000000);
            settings.setValue("chfFactor", (1.0 / json.get<double>("chf")) * 100000000);
            settings.setValue("clpFactor", (1.0 / json.get<double>("clp")) * 100000000);
            settings.setValue("czkFactor", (1.0 / json.get<double>("czk")) * 100000000);
            settings.setValue("dkkFactor", (1.0 / json.get<double>("dkk")) * 100000000);
            settings.setValue("gbpFactor", (1.0 / json.get<double>("gbp")) * 100000000);
            settings.setValue("hkdFactor", (1.0 / json.get<double>("hkd")) * 100000000);
            settings.setValue("hufFactor", (1.0 / json.get<double>("huf")) * 100000000);
            settings.setValue("idrFactor", (1.0 / json.get<double>("idr")) * 100000000);
            settings.setValue("ilsFactor", (1.0 / json.get<double>("ils")) * 100000000);
            settings.setValue("inrFactor", (1.0 / json.get<double>("inr")) * 100000000);
            settings.setValue("jpyFactor", (1.0 / json.get<double>("jpy")) * 100000000);
            settings.setValue("krwFactor", (1.0 / json.get<double>("krw")) * 100000000);
            settings.setValue("mxnFactor", (1.0 / json.get<double>("mxn")) * 100000000);
            settings.setValue("myrFactor", (1.0 / json.get<double>("myr")) * 100000000);
            settings.setValue("nokFactor", (1.0 / json.get<double>("nok")) * 100000000);
            settings.setValue("nzdFactor", (1.0 / json.get<double>("nzd")) * 100000000);
            settings.setValue("phpFactor", (1.0 / json.get<double>("php")) * 100000000);
            settings.setValue("pkrFactor", (1.0 / json.get<double>("pkr")) * 100000000);
            settings.setValue("plnFactor", (1.0 / json.get<double>("pln")) * 100000000);
            settings.setValue("rubFactor", (1.0 / json.get<double>("rub")) * 100000000);
            settings.setValue("sekFactor", (1.0 / json.get<double>("sek")) * 100000000);
            settings.setValue("sgdFactor", (1.0 / json.get<double>("sgd")) * 100000000);
            settings.setValue("thbFactor", (1.0 / json.get<double>("thb")) * 100000000);
            settings.setValue("tryFactor", (1.0 / json.get<double>("try")) * 100000000);
            settings.setValue("twdFactor", (1.0 / json.get<double>("twd")) * 100000000);
            settings.setValue("zarFactor", (1.0 / json.get<double>("zar")) * 100000000);
