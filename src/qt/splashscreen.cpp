...
{
    wallet->ShowProgress.connect(std::bind(ShowProgress, splash, _1, _2));
}
#endif
...
void SplashScreen::subscribeToCoreSignals()
{
    ...
    uiInterface.InitMessage.connect(std::bind(InitMessage, this, _1));
    uiInterface.ShowProgress.connect(std::bind(ShowProgress, this, _1, _2));
#ifdef ENABLE_WALLET
    uiInterface.LoadWallet.connect(std::bind(ConnectWallet, this, _1));
#endif
}
...
void SplashScreen::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.InitMessage.disconnect(std::bind(InitMessage, this, _1));
    uiInterface.ShowProgress.disconnect(std::bind(ShowProgress, this, _1, _2));
#ifdef ENABLE_WALLET
    if(pwalletMain)
        pwalletMain->ShowProgress.disconnect(std::bind(ShowProgress, this, _1, _2));
#endif
}
